          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm font-medium text-cosmicpurple hover:underline dark:text-primary-500">Forgot password?</a>
              </div>
              ...
              <div className="flex items-center justify-center">
                <button
                  type="submit"
                  className="w-36 h-10 bg-cosmicpurple text-white hover:bg-purple2 focus:ring-2 focus:ring-purple-800 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 text-center transition duration-300 ease-in-out"
                >
                  Confirm
                </button>
              </div>
              ...
              <p className="text-sm font-light text-white">
                Don’t have an account yet? <a href="/signup" className="font-medium text-cosmicpurple hover:underline dark:text-primary-500">Sign up</a>
              </p>
            </form>
          </div>
        </div>
